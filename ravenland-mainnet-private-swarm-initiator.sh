...
# written by push at ravenland _dot org
# Makes a completely private ipfs node joining the Ravenland/Ravencoin Private IPFS Swarm with swarm.key
# connects to a bootstrap of 4 IPFS seeds with mirror of ravencoin chain content in the cloud
